...
### Packages
```
# Shared KMM module (shared/src/commonMain/...)
lu.esklepios.app.data.db
...
lu.esklepios.app.di
lu.esklepios.app.util

# Android app (androidApp/src/main/kotlin/...)
lu.esklepios.app.core.navigation                       # NavDestination, AppNavGraph
lu.esklepios.app.core.ui.components                    # AppCard, FormField, …
lu.esklepios.app.core.ui.theme                         # Color, Dimens, Typography, Gradients, AppTheme
lu.esklepios.app.view.<area>.<screen>                  # auth/login, dashboard/home, dashboard/profile, landing, splash
lu.esklepios.app.di                                    # AndroidModule.kt
lu.esklepios.app.storage                               # SecureStorage.kt
lu.esklepios.app.utils                                 # DateUtil.kt
lu.esklepios.app.debug                                 # DummyPractitioners.kt (debug-only fixtures)
lu.esklepios.app.data.auth                             # Android-only auth data adapters (Google/Apple SSO)
```
