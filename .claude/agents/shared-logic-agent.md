...
│   │   ├── network/         ← ApiService, KtorApiService, HttpClientFactory, TokenStorage, DTOs.kt, Mappers.kt
...
val sharedModule = module {
    // Network
    single { HttpClientFactory(get(), enableLogging = BuildKonfig.ENABLE_LOGGING).create() }
