...
class BookAppointmentViewModelTest {
    ...
    @Test
    fun `initial state isAuthenticated reflects auth repository`() = runTest {
        every { authRepository.isLoggedIn() } returns false
    ...
    @Test
    fun `checkAuth sets isAuthenticated true when logged in`() = runTest {
    ...
    @Test
    fun `loadData populates practitioner and slot`() = runTest {
    ...
    @Test
    fun `confirm without auth sets error`() = runTest {
        every { authRepository.isLoggedIn() } returns false
        every { authRepository.getCurrentUser() } returns null
    ...
    @Test
    fun `confirm with auth and valid data sets isConfirmed`() = runTest {
        every { authRepository.isLoggedIn() } returns true
    ...
    @Test
    fun `confirm failure sets error state`() = runTest {
        every { authRepository.isLoggedIn() } returns true
        every { authRepository.getCurrentUser() } returns testUser
    ...
    @Test
    fun `updateConsultationReason updates state`() = runTest {
    ...
    @Test
    fun `updateMessageToDoctor updates state`() = runTest {
