...
object DummyPractitioners {
    ...
    // ── Dr. Fabien Cipriani ───────────────────────────────────────────────────
    private val cipriani = Practitioner(
        id = "d1",
        firstName = "Fabien",
        lastName = "Cipriani",
    ...
    // ── Dr. Marie Hoffmann ────────────────────────────────────────────────────
    private val hoffmann = Practitioner(
        id = "d2",
        firstName = "Marie",
        lastName = "Hoffmann",
    ...
    // ── Dr. Pierre Lecomte ────────────────────────────────────────────────────
    private val lecomte = Practitioner(
        id = "d3",
        firstName = "Pierre",
        lastName = "Lecomte",
    ...
    // ── Dr. Jean Dupont ───────────────────────────────────────────────────────
    private val dupont = Practitioner(
        id = "d5",
        firstName = "Jean",
        lastName = "Dupont",
