...
object DateUtil {
    ...
    fun formatSlotSummary(
        isoDate: String,
        slotId: String,
    ): String = "${formatIsoDate(isoDate, PATTERN_DISPLAY_FULL)} · ${extractSlotTime(slotId)}"
    ...
    fun formatSlotSummary(isoDateTime: String): String =
        try {
    ...
    fun formatDateTimeSummary(
        dateLabel: String,
        timeLabel: String,
    ): String = "$dateLabel · $timeLabel"
