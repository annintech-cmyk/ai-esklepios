...
class HomeViewModelTest {
    ...
    private fun makePractitioner(id: String = "1") =
        Practitioner(
            id = id,
            firstName = "John",
            lastName = "Doe",
    ...
    @Test
    fun `initial state has empty practitioners`() =
        runTest {
    ...
    @Test
    fun `search success updates practitioners list`() =
        runTest {
    ...
    @Test
    fun `setDateFilter updates selectedDateFilter`() =
        runTest {
    ...
    @Test
    fun `setDateFilter replaces previous selection`() =
        runTest {
            viewModel.setDateFilter("Today")
    ...
    @Test
    fun `toggleNewPatientsFilter flips openToNewPatients`() =
        runTest {
    ...
    @Test
    fun `updateSearchQuery updates searchQuery in state`() =
        runTest {
