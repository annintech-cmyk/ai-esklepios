...
class PractitionerRepositoryTest {
    ...
    companion object {
        fun fakePractitioner(id: String) =
            Practitioner(
                id = id,
                firstName = "Jane",
                lastName = "Doctor",
    ...
    @Test
    fun `searchPractitioners returns list on success`() =
        runTest {
    ...
    @Test
    fun `searchPractitioners propagates error`() =
        runTest {
            val repo =
                FakePractitionerRepository().also {
    ...
    @Test
    fun `getPractitionerById returns practitioner on success`() =
        runTest {
            val repo =
                FakePractitionerRepository().also {
    ...
    @Test
    fun `getPractitionerById propagates not found error`() =
        runTest {
            val repo =
                FakePractitionerRepository().also {
    ...
    @Test
    fun `toggleFavorite returns success`() =
        runTest {
    ...
    @Test
    fun `toggleFavorite propagates failure`() =
        runTest {
            val repo =
                FakePractitionerRepository().also {
