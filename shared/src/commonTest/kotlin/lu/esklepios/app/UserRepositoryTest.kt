...
class UserRepositoryTest {
    ...
    @Test
    fun `getProfile returns success with user`() = runTest {
    ...
    @Test
    fun `getProfile failure propagates`() = runTest {
    ...
    @Test
    fun `updateProfile returns updated user`() = runTest {
    ...
    @Test
    fun `updateProfile failure propagates`() = runTest {
    ...
    @Test
    fun `changeEmail success returns Unit`() = runTest {
        assertTrue(repo.changeEmail("new@test.lu", "pass").isSuccess)
    }

    @Test
    fun `changeEmail failure propagates`() = runTest {
    ...
    @Test
    fun `changePassword failure propagates`() = runTest {
