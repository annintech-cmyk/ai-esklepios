...
class AppointmentRepositoryTest {
    ...
    @Test
    fun `createAppointment returns created appointment`() =
        runTest {
    ...
    @Test
    fun `createAppointment failure propagates error`() =
        runTest {
    ...
    @Test
    fun `getUpcomingAppointments returns list`() =
        runTest {
    ...
    @Test
    fun `getPastAppointments returns completed appointments`() =
        runTest {
            val past =
                listOf(
    ...
    @Test
    fun `cancelAppointment delegates to repository with correct id`() =
        runTest {
    ...
    @Test
    fun `cancelAppointment failure propagates`() =
        runTest {
    ...
    @Test
    fun `modifyAppointment returns modified appointment`() =
        runTest {
