...
extension Color {
    ...
    static let appTealAccent = Color(hex: "4DD0E1")
    static let appInputBackground = Color(hex: "F3F4F6")

    // Profile icon palette
    static let appIconBgBlue   = Color(hex: "EEF0FD")
    static let appIconBgPink   = Color(hex: "FFEBF0")
    static let appIconBgOrange = Color(hex: "FFF3E0")
    static let appIconBgTeal   = Color(hex: "E0F7FA")
    static let appIconBgGreen  = Color(hex: "E8F5E9")
    static let appIconTintPink   = Color(hex: "E91E63")
    static let appIconTintOrange = Color(hex: "FF9800")
    static let appIconTintTeal   = Color(hex: "00ACC1")
    static let appIconTintGreen  = Color(hex: "43A047")

    static let appStrengthGood      = Color(hex: "65A30D")
    static let appFavoriteRed       = Color(hex: "FF6B6B")
    static let appGoogleBlue        = Color(hex: "4285F4")
    static let appAvatarGradientEnd = Color(hex: "DDE1FB")
    static let appOldApptAmber      = Color(hex: "854F0B")
    static let appOldApptAmberIcon  = Color(hex: "D97706")
